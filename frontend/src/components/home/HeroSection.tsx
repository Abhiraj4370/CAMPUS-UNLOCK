...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-sky-50 via-white to-violet-50">
      <div className="max-w-[1260px] mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-8 lg:gap-11 items-center pt-8 sm:pt-14 pb-10">
        ...
        <div className="relative mt-4 lg:mt-0 w-full">
          ...
          {/* Floating Badges */}
          <FloatingBadge icon={<GraduationCap size={17} />} tone="bg-primary-100 text-primary-600" value="250+" label="Universities" className="top-[4%] left-[2%] z-20" />
          <FloatingBadge icon={<BookOpen size={17} />} tone="bg-violet-100 text-violet-600" value="5000+" label="Online Courses" className="top-[40%] -left-4 sm:-left-8 z-20" />
          <FloatingBadge icon={<Users size={17} />} tone="bg-emerald-100 text-emerald-600" value="50K+" label="Happy Students" className="top-[6%] -right-4 sm:-right-6 z-20" />
          <FloatingBadge icon={<Star size={17} />} tone="bg-amber-100 text-amber-600" value="4.8/5" label="Average Rating" className="bottom-[6%] right-4 z-20" />
        </div>
      </div>
